...
from DMFNER import input_reader
from DMFNER.diffusionner_trainer import DiffusionNERTrainer
import warnings
...
if __name__ == '__main__':
    ...
    if args.mode == 'train':
        ...
        raise Exception("Mode not in ['train', 'eval'], e.g. 'python DMFNER.py train ...'")
